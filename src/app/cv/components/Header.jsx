      ...
      <Container fluid>
        <NavbarCollapse>
          <Nav className="navbar-centre">
            ...
            <NavItem>
              <NavLink href="mailto:t.gribanow@gmail.com" target="_blank">
                <EnvelopeFill className="me-1"/>t.gribanow@gmail.com
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink href="https://www.linkedin.com/in/timagribanov/" target="_blank">
                <Linkedin className="me-1"/>linkedin.com/in/timagribanov
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink href="https://github.com/TimaGribanov" target="_blank">
